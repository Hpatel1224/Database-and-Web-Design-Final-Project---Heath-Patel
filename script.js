...
let Super_Sectors_ID = Object.keys(Super_Sectors)
console.log(Super_Sectors_ID)
...
console.log ("error");
  ...
  if(response==Super_Sectors_ID.length) {
...
for (let i=0; i<Super_Sectors_ID.length; i++) {
let startquery = "https://api.bls.gov/publicAPI/v2/timeseries/data/CEU"
let endquery = "00000001?registrationkey=5ed5853a0b5e470b838bce71fb48c8b8"
...
xhr.open("GET", startquery+Super_Sectors_ID[i]+endquery);
xhr.send();
}